<?php
...

	{
		...
		add_settings_field('bitcoin_calculator_dropdown_currency', 'Default calculator currency', 'set_bitcoin_calculator_dropdown', 'bitcoin_calculator_settings_page', 'bitcoin_calculator_section');
